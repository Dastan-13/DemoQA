...
public class RandomUtils {
    ...
    public PracticeFormEntity generateRandomPracticeFormEntity() {
        ...
        practiceFormEntity.setUserMail(faker.internet().emailAddress());
        practiceFormEntity.setMobileNumber(faker.phoneNumber().subscriberNumber(12));
//        practiceFormEntity.setDate(faker.date().birthday().toString());
//        practiceFormEntity.setSubjects("B");
        practiceFormEntity.setSubjects("M");
        practiceFormEntity.setPicture("C:\\Users\\user\\IdeaProjects\\DemoQAWinter24\\src\\main\\resources\\pictures\\3. Леопард.jpg");
        practiceFormEntity.setAddress(faker.address().fullAddress());
